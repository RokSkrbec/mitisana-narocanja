...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Fe(e,t){if(e){if(typeof e==`string`)return Re(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?Re(e,t):void 0}}function Ie(e){if(typeof Symbol<`u`&&e[Symbol.iterator]!=null||e[`@@iterator`]!=null)return Array.from(e)}function Le(e){if(Array.isArray(e))return Re(e)}function Re(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}var ze={name:`SelectButton`,extends:je,inheritAttrs:!1,emits:[`change`],methods:{getOptionLabel:function(e){return this.optionLabel?W(e,this.optionLabel):e},getOptionValue:function(e){return this.optionValue?W(e,this.optionValue):e},getOptionRenderKey:function(e){return this.dataKey?W(e,this.dataKey):this.getOptionLabel(e)},isOptionDisabled:function(e){return this.optionDisabled?W(e,this.optionDisabled):!1},isOptionReadonly:function(e){if(this.allowEmpty)return!1;var t=this.isSelected(e);return this.multiple?t&&this.d_value.length===1:t},onOptionSelect:function(e,t,n){var r=this;if(!(this.disabled||this.isOptionDisabled(t)||this.isOptionReadonly(t))){var i=this.isSelected(t),a=this.getOptionValue(t),o;if(this.multiple)if(i){if(o=this.d_value.filter(function(e){return!v(e,a,r.equalityKey)}),!this.allowEmpty&&o.length===0)return}else o=this.d_value?[].concat(Ne(this.d_value),[a]):[a];else{if(i&&!this.allowEmpty)return;o=i?null:a}this.writeValue(o,e),this.$emit(`change`,{originalEvent:e,value:o})}},isSelected:function(e){var t=!1,n=this.getOptionValue(e);if(this.multiple){if(this.d_value){var r=Me(this.d_value),i;try{for(r.s();!(i=r.n()).done;){var a=i.value;if(v(a,n,this.equalityKey)){t=!0;break}}}catch(e){r.e(e)}finally{r.f()}}}else t=v(this.d_value,n,this.equalityKey);return t}},computed:{equalityKey:function(){return this.optionValue?null:this.dataKey},dataP:function(){return P({invalid:this.$invalid})}},directives:{ripple:_},components:{ToggleButton:Ee}},Be=[`aria-labelledby`,`data-p`];function Ve(e,n,r,i,o,l){var u=A(`ToggleButton`);return T(),x(`div`,c({class:e.cx(`root`),role:`group`,"aria-labelledby":e.ariaLabelledby},e.ptmi(`root`),{"data-p":l.dataP}),[(T(!0),x(a,null,h(e.options,function(n,r){return T(),K(u,{key:l.getOptionRenderKey(n),modelValue:l.isSelected(n),onLabel:l.getOptionLabel(n),offLabel:l.getOptionLabel(n),disabled:e.disabled||l.isOptionDisabled(n),unstyled:e.unstyled,size:e.size,readonly:l.isOptionReadonly(n),onChange:function(e){return l.onOptionSelect(e,n,r)},pt:e.ptm(`pcToggleButton`)},s({_:2},[e.$slots.option?{name:`default`,fn:E(function(){return[t(e.$slots,`option`,{option:n,index:r},function(){return[g(`span`,c({ref_for:!0},e.ptm(`pcToggleButton`).label),R(l.getOptionLabel(n)),17)]})]}),key:`0`}:void 0]),1032,[`modelValue`,`onLabel`,`offLabel`,`disabled`,`unstyled`,`size`,`readonly`,`onChange`,`pt`])}),128))],16,Be)}ze.render=Ve;var He={class:`flex items-center gap-3 px-4 py-2 border-b border-gray-200 bg-white z-10 flex-shrink-0`},Ue={class:`flex-1 text-sm font-semibold text-gray-700 text-center truncate`},We=l({__name:`CalendarToolbar`,props:{headerLabel:{},view:{}},emits:[`navigate`,`today`,`change-view`,`block-time`],setup(e){let t=[{label:`Dan`,value:`day`},{label:`Teden`,value:`week`},{label:`Mesec`,value:`month`}],n=ce(),r=te();async function i(){await n.logout(),r.push(`/login`)}return(n,r)=>{let a=A(`router-link`),s=V(`tooltip`);return T(),x(`header`,He,[r[5]||=g(`div`,{class:`flex items-center gap-2 mr-2`},[g(`div`,{class:`w-8 h-8 bg-pink-500 rounded-lg flex items-center justify-center`},[g(`i`,{class:`pi pi-calendar text-white text-sm`})]),g(`span`,{class:`font-bold text-gray-800 hidden sm:block`},`Mitisana`)],-1),o(N(G),{icon:`pi pi-chevron-left`,text:``,rounded:``,size:`small`,onClick:r[0]||=e=>n.$emit(`navigate`,-1)}),o(N(G),{label:`Danes`,text:``,size:`small`,onClick:r[1]||=e=>n.$emit(`today`)}),o(N(G),{icon:`pi pi-chevron-right`,text:``,rounded:``,size:`small`,onClick:r[2]||=e=>n.$emit(`navigate`,1)}),g(`span`,Ue,R(e.headerLabel),1),o(N(ze),{"model-value":e.view,options:t,"option-label":`label`,"option-value":`value`,size:`small`,"onUpdate:modelValue":r[3]||=e=>n.$emit(`change-view`,e)},null,8,[`model-value`]),L(o(N(G),{icon:`pi pi-lock`,text:``,rounded:``,size:`small`,severity:`secondary`,onClick:r[4]||=e=>n.$emit(`block-time`)},null,512),[[s,`Blokiraj čas`,void 0,{bottom:!0}]]),o(a,{to:`/clients`},{default:E(()=>[L(o(N(G),{icon:`pi pi-users`,text:``,rounded:``,size:`small`},null,512),[[s,`Stranke`,void 0,{bottom:!0}]])]),_:1}),o(a,{to:`/statistics`},{default:E(()=>[L(o(N(G),{icon:`pi pi-chart-bar`,text:``,rounded:``,size:`small`},null,512),[[s,`Statistika`,void 0,{bottom:!0}]])]),_:1}),o(a,{to:`/settings`},{default:E(()=>[L(o(N(G),{icon:`pi pi-cog`,text:``,rounded:``,size:`small`},null,512),[[s,`Nastavitve`,void 0,{bottom:!0}]])]),_:1}),L(o(N(G),{icon:`pi pi-sign-out`,text:``,rounded:``,size:`small`,severity:`secondary`,onClick:i},null,512),[[s,`Odjava`,void 0,{bottom:!0}]])])}}});function Ge(e){let t=J(),n=O(null),r=O(0);function i(t,i){n.value=t,i.dataTransfer&&(i.dataTransfer.effectAllowed=`move`,i.dataTransfer.setData(`appointmentId`,t.id));let a=i.currentTarget.getBoundingClientRect(),o=i.clientY-a.top;r.value=Math.floor(o/e)*5}function a(e){e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`move`)}async function o(i,a,o){if(i.preventDefault(),!n.value)return;let s=o.getBoundingClientRect(),c=i.clientY-s.top,l=Math.floor(c/e)*5-r.value,u=new Date(a);u.setHours(0,0,0,0),u.setMinutes(Math.max(0,l));let d=(n.value.endTime.getTime()-n.value.startTime.getTime())/6e4,f=new Date(u.getTime()+d*6e4);await t.updateAppointment(n.value.id,{startTime:u,endTime:f}),n.value=null}function s(){n.value=null}return{dragging:n,onDragStart:i,onDragOver:a,onDrop:o,onDragEnd:s}}var Ke=[`draggable`],qe={class:`flex items-start gap-1 h-full min-w-0`},Je={key:0,class:`pi pi-lock text-gray-400 flex-shrink-0 mt-0.5`,style:{"font-size":`10px`}},Ye={key:1,class:`pi pi-times-circle flex-shrink-0 mt-0.5 opacity-80`,style:{"font-size":`10px`}},Xe={key:2,class:`pi pi-user-minus flex-shrink-0 mt-0.5 opacity-80`,style:{"font-size":`10px`}},Ze={class:`min-w-0 flex-1`},Qe={key:0,class:`opacity-80 truncate leading-tight`},$e=l({__name:`AppointmentBlock`,props:{appointment:{},top:{},height:{},resizing:{type:Boolean}},emits:[`drag-start`,`drag-end`,`edit`,`resize-start`,`touch-drag-start`],setup(e){function t(e){return e.toLocaleTimeString(`sl-SI`,{hour:`2-digit`,minute:`2-digit`})}return(r,i)=>(T(),x(`div`,{class:H([`absolute left-1 right-1 rounded-lg px-2 py-1 text-xs font-medium shadow select-none overflow-hidden group`,[e.resizing?`cursor-ns-resize`:`cursor-grab`,e.appointment.blocked?`text-gray-600`:`text-white`,e.appointment.status===`cancelled`?`opacity-50`:``]]),style:j({top:`${e.top}px`,height:`${e.height}px`,backgroundColor:e.appointment.blocked?`#e5e7eb`:e.appointment.color,backgroundImage:e.appointment.blocked?`repeating-linear-gradient(45deg, transparent, transparent 4px, rgba(0,0,0,0.06) 4px, rgba(0,0,0,0.06) 8px)`:e.appointment.status===`cancelled`?`repeating-linear-gradient(135deg, transparent, transparent 4px, rgba(0,0,0,0.15) 4px, rgba(0,0,0,0.15) 8px)`:`none`,borderLeft:e.appointment.blocked?`3px solid #9ca3af`:e.appointment.status===`no-show`?`3px solid rgba(0,0,0,0.35)`:`none`,minHeight:`20px`,zIndex:e.resizing?30:10}),draggable:!e.resizing,onDragstart:i[2]||=t=>!e.resizing&&r.$emit(`drag-start`,e.appointment,t),onDragend:i[3]||=e=>r.$emit(`drag-end`),onClick:i[4]||=m(t=>!e.resizing&&r.$emit(`edit`,e.appointment),[`stop`]),onTouchstart:i[5]||=m(t=>!e.resizing&&r.$emit(`touch-drag-start`,e.appointment,t),[`stop`,`prevent`])},[g(`div`,qe,[e.appointment.blocked?(T(),x(`i`,Je)):e.appointment.status===`cancelled`?(T(),x(`i`,Ye)):e.appointment.status===`no-show`?(T(),x(`i`,Xe)):n(``,!0),g(`div`,Ze,[g(`p`,{class:H([`font-semibold leading-tight truncate`,e.appointment.status===`cancelled`?`line-through`:``])},R(e.appointment.clientName),3),!e.appointment.blocked&&e.height>30?(T(),x(`p`,Qe,R(e.appointment.typeName),1)):n(``,!0),e.height>44?(T(),x(`p`,{key:1,class:H([`opacity-70 text-[10px] leading-tight`,e.appointment.blocked?`text-gray-500`:``])},R(t(e.appointment.startTime))+` – `+R(t(e.appointment.endTime)),3)):n(``,!0)])]),g(`div`,{class:`absolute bottom-0 left-0 right-0 h-5 flex items-center justify-center cursor-ns-resize group/handle`,onMousedown:i[0]||=m(t=>r.$emit(`resize-start`,e.appointment,t),[`stop`]),onTouchstart:i[1]||=m(t=>r.$emit(`resize-start`,e.appointment,t),[`stop`,`prevent`])},[g(`div`,{class:H([`w-6 h-0.5 rounded-full opacity-0 group-hover:opacity-60 transition-opacity`,e.appointment.blocked?`bg-gray-500`:`bg-white`])},null,2)],32)],46,Ke))}}),et={class:`flex flex-1 min-h-0 overflow-y-auto overflow-x-auto`},tt={key:0,class:`text-[10px] text-gray-400 -translate-y-2`},nt={class:`flex flex-1`},rt=[`onDrop`],it=[`onClick`],at=l({__name:`TimeGrid`,props:{days:{},appointments:{},timeSlots:{},slotHeight:{},topForTime:{type:Function},heightForDuration:{type:Function},snapToFive:{type:Function},appointmentsForDay:{type:Function}},emits:[`add-appointment`,`edit-appointment`],setup(e,{emit:t}){let r=e,i=t,o=O([]),s=d(()=>r.timeSlots.length*r.slotHeight),c=Ge(r.slotHeight),l=J(),u=O(null),f=O(0),p=null,m=0,_=0;function v(e){return e instanceof TouchEvent?e.touches[0]?.clientY??e.changedTouches[0]?.clientY??0:e.clientY}function y(e,t,n){p=e,u.value=e.id,m=v(t),_=r.heightForDuration(e.startTime,e.endTime),f.value=_,t instanceof TouchEvent?(window.addEventListener(`touchmove`,E,{passive:!1}),window.addEventListener(`touchend`,k),window.addEventListener(`touchcancel`,k)):(window.addEventListener(`mousemove`,S),window.addEventListener(`mouseup`,D))}function b(e){let t=e-m,n=Math.round(t/r.slotHeight)*r.slotHeight,i=r.slotHeight;f.value=Math.max(i,_+n)}function S(e){p&&b(e.clientY)}function E(e){p&&(e.preventDefault(),b(e.touches[0].clientY))}async function D(){window.removeEventListener(`mousemove`,S),window.removeEventListener(`mouseup`,D),await A()}async function k(){window.removeEventListener(`touchmove`,E),window.removeEventListener(`touchend`,k),window.removeEventListener(`touchcancel`,k),await A()}async function A(){if(!p)return;let e=Math.round(f.value/r.slotHeight)*5,t=new Date(p.startTime.getTime()+e*6e4);await l.updateAppointment(p.id,{endTime:t}),u.value=null,p=null}let M=O(null),P=O(0),F=O(-1),I=0,L=0,z=0,B=O(!1);function ee(e,t){if(u.value)return;let n=t.touches[0];L=n.clientX,z=n.clientY,B.value=!1,M.value=e;let i=V(n.clientX);if(F.value=i,i>=0&&i<o.value.length){let t=o.value[i].getBoundingClientRect(),a=r.topForTime(e.startTime);I=n.clientY-t.top-a;let s=r.heightForDuration(e.startTime,e.endTime);I=Math.max(0,Math.min(I,s-r.slotHeight))}P.value=r.topForTime(e.startTime),window.addEventListener(`touchmove`,W,{passive:!1}),window.addEventListener(`touchend`,G),window.addEventListener(`touchcancel`,te)}function V(e){for(let t=0;t<o.value.length;t++){let n=o.value[t].getBoundingClientRect();if(e>=n.left&&e<=n.right)return t}return 0}function U(e,t){if(t<0||t>=o.value.length)return 0;let n=e-o.value[t].getBoundingClientRect().top-I;return Math.max(0,Math.round(n/r.slotHeight)*r.slotHeight)}function W(e){if(!M.value)return;e.preventDefault();let t=e.touches[0];if(!B.value){let e=t.clientX-L,n=t.clientY-z;Math.sqrt(e*e+n*n)>8&&(B.value=!0)}F.value=V(t.clientX),P.value=U(t.clientY,F.value)}async function G(e){if(window.removeEventListener(`touchmove`,W),window.removeEventListener(`touchend`,G),window.removeEventListener(`touchcancel`,te),!M.value)return;let t=M.value,n=F.value,a=B.value;if(M.value=null,F.value=-1,B.value=!1,!a){i(`edit-appointment`,t);return}let o=r.days[Math.max(0,Math.min(n,r.days.length-1))],s=Math.round(P.value/r.slotHeight)*5,c=new Date(o);c.setHours(0,0,0,0),c.setMinutes(s);let u=(t.endTime.getTime()-t.startTime.getTime())/6e4,d=new Date(c.getTime()+u*6e4);await l.updateAppointment(t.id,{startTime:c,endTime:d})}function te(){window.removeEventListener(`touchmove`,W),window.removeEventListener(`touchend`,G),window.removeEventListener(`touchcancel`,te),M.value=null,F.value=-1,B.value=!1}let ne=O(0),q;function re(){let e=new Date;ne.value=r.topForTime(e)}w(()=>{re(),q=setInterval(re,6e4);let e=480*(r.slotHeight/5);setTimeout(()=>{let t=o.value[0]?.closest(`.overflow-y-auto`);t&&(t.scrollTop=e)},50)}),C(()=>clearInterval(q));function ie(e){let t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function ae(e,t){let[n,r]=t.split(`:`).map(Number),a=new Date(e);a.setHours(n,r,0,0),i(`add-appointment`,a)}function oe(e,t){c.onDragStart(e,t)}function se(e){c.onDragOver(e)}function ce(e,t,n){c.onDrop(e,t,n)}return(t,r)=>(T(),x(`div`,et,[g(`div`,{class:`sticky left-0 z-10 w-14 flex-shrink-0 border-r border-gray-100 bg-white relative`,style:j({height:s.value+`px`})},[(T(!0),x(a,null,h(e.timeSlots,(t,r)=>(T(),x(`div`,{key:t,class:`absolute left-0 right-0 flex items-start justify-end pr-2`,style:j({top:`${r*e.slotHeight}px`,height:`${e.slotHeight}px`})},[r%12==0?(T(),x(`span`,tt,R(t),1)):n(``,!0)],4))),128))],4),g(`div`,nt,[(T(!0),x(a,null,h(e.days,(i,l)=>(T(),x(`div`,{key:l,ref_for:!0,ref_key:`columnRefs`,ref:o,class:`flex-1 min-w-[80px] border-r border-gray-100 relative`,style:j({height:s.value+`px`}),onDragover:r[3]||=e=>se(e),onDrop:e=>ce(e,i,o.value[l])},[(T(!0),x(a,null,h(e.timeSlots,(t,n)=>(T(),x(`div`,{key:t,class:H([`absolute left-0 right-0 border-t cursor-pointer hover:bg-pink-50 transition-colors`,n%12==0?`border-gray-200`:`border-gray-50`]),style:j({top:`${n*e.slotHeight}px`,height:`${e.slotHeight}px`}),onClick:e=>ae(i,t)},null,14,it))),128)),ie(i)?(T(),x(`div`,{key:0,class:`absolute left-0 right-0 z-20 pointer-events-none`,style:j({top:`${ne.value}px`})},[...r[4]||=[g(`div`,{class:`relative`},[g(`div`,{class:`absolute -left-1 w-2.5 h-2.5 rounded-full bg-pink-500 -translate-y-1/2`}),g(`div`,{class:`border-t-2 border-pink-500`})],-1)]],4)):n(``,!0),(T(!0),x(a,null,h(e.appointmentsForDay(e.appointments,i),n=>(T(),K($e,{key:n.id,appointment:n,top:e.topForTime(n.startTime),height:u.value===n.id?f.value:e.heightForDuration(n.startTime,n.endTime),resizing:u.value===n.id,onDragStart:r[0]||=(e,t)=>oe(e,t),onDragEnd:r[1]||=e=>N(c).onDragEnd(),onEdit:e=>t.$emit(`edit-appointment`,n),onResizeStart:(e,t)=>y(e,t,o.value[l]),onTouchDragStart:r[2]||=(e,t)=>ee(e,t)},null,8,[`appointment`,`top`,`height`,`resizing`,`onEdit`,`onResizeStart`]))),128)),M.value&&B.value&&F.value===l?(T(),x(`div`,{key:1,class:`absolute left-1 right-1 rounded-lg opacity-70 pointer-events-none z-40 border-2 border-white`,style:j({top:`${P.value}px`,height:`${M.value?e.heightForDuration(M.value.startTime,M.value.endTime):0}px`,backgroundColor:M.value.blocked?`#e5e7eb`:M.value.color})},null,4)):n(``,!0)],44,rt))),128))])]))}}),ot={class:`flex flex-col flex-1 min-h-0 overflow-hidden`},st={class:`flex border-b border-gray-200 bg-white flex-shrink-0`},ct={class:`flex-1 py-2 px-4`},lt={class:`text-[10px] font-medium uppercase opacity-70`},ut={class:`text-lg font-bold leading-none`},dt=l({__name:`DayView`,props:{date:{},appointments:{},timeSlots:{},slotHeight:{},topForTime:{type:Function},heightForDuration:{type:Function},snapToFive:{type:Function},appointmentsForDay:{type:Function}},emits:[`add-appointment`,`edit-appointment`],setup(e){let t=e,n=d(()=>{let e=new Date;return t.date.getFullYear()===e.getFullYear()&&t.date.getMonth()===e.getMonth()&&t.date.getDate()===e.getDate()}),r=d(()=>t.date.toLocaleDateString(`sl-SI`,{weekday:`short`}));return(t,i)=>(T(),x(`div`,ot,[g(`div`,st,[i[2]||=g(`div`,{class:`w-14 flex-shrink-0`},null,-1),g(`div`,ct,[g(`div`,{class:H([`inline-flex flex-col items-center justify-center w-10 h-10 rounded-full`,n.value?`bg-pink-500 text-white`:`text-gray-700`])},[g(`span`,lt,R(r.value),1),g(`span`,ut,R(e.date.getDate()),1)],2)])]),o(at,{days:[e.date],appointments:e.appointments,"time-slots":e.timeSlots,"slot-height":e.slotHeight,"top-for-time":e.topForTime,"height-for-duration":e.heightForDuration,"snap-to-five":e.snapToFive,"appointments-for-day":e.appointmentsForDay,onAddAppointment:i[0]||=e=>t.$emit(`add-appointment`,e),onEditAppointment:i[1]||=e=>t.$emit(`edit-appointment`,e)},null,8,[`days`,`appointments`,`time-slots`,`slot-height`,`top-for-time`,`height-for-duration`,`snap-to-five`,`appointments-for-day`])]))}}),ft={class:`flex flex-col flex-1 min-h-0 overflow-hidden`},pt={class:`flex border-b border-gray-200 bg-white flex-shrink-0`},mt={class:`flex flex-1 overflow-x-auto`},ht={class:`text-[10px] font-medium uppercase text-gray-400`},gt=l({__name:`WeekView`,props:{weekDays:{},appointments:{},timeSlots:{},slotHeight:{},topForTime:{type:Function},heightForDuration:{type:Function},snapToFive:{type:Function},appointmentsForDay:{type:Function}},emits:[`add-appointment`,`edit-appointment`],setup(e){function t(e){let t=new Date;return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}return(n,r)=>(T(),x(`div`,ft,[g(`div`,pt,[r[2]||=g(`div`,{class:`w-14 flex-shrink-0`},null,-1),g(`div`,mt,[(T(!0),x(a,null,h(e.weekDays,e=>(T(),x(`div`,{key:e.toISOString(),class:`flex-1 min-w-[80px] flex flex-col items-center py-2`},[g(`span`,ht,R(e.toLocaleDateString(`sl-SI`,{weekday:`short`})),1),g(`div`,{class:H([`w-9 h-9 flex items-center justify-center rounded-full text-sm font-bold mt-0.5`,t(e)?`bg-pink-500 text-white`:`text-gray-700`])},R(e.getDate()),3)]))),128))])]),o(at,{days:e.weekDays,appointments:e.appointments,"time-slots":e.timeSlots,"slot-height":e.slotHeight,"top-for-time":e.topForTime,"height-for-duration":e.heightForDuration,"snap-to-five":e.snapToFive,"appointments-for-day":e.appointmentsForDay,onAddAppointment:r[0]||=e=>n.$emit(`add-appointment`,e),onEditAppointment:r[1]||=e=>n.$emit(`edit-appointment`,e)},null,8,[`days`,`appointments`,`time-slots`,`slot-height`,`top-for-time`,`height-for-duration`,`snap-to-five`,`appointments-for-day`])]))}}),_t={class:`flex flex-col flex-1 overflow-hidden p-4`},vt={class:`grid grid-cols-7 mb-1`},yt={class:`grid grid-cols-7 flex-1 gap-1 overflow-y-auto`},bt=[`onClick`],xt={class:`flex justify-end mb-1`},St={class:`flex flex-col gap-0.5 overflow-hidden`},Ct=[`onClick`],wt={key:0,class:`text-[10px] text-gray-400 pl-1`},Tt=l({__name:`MonthView`,props:{currentDate:{},monthDays:{},appointments:{},isSameDay:{type:Function},isCurrentMonth:{type:Function},appointmentsForDay:{type:Function}},emits:[`add-appointment`,`edit-appointment`],setup(e){let t=new Date,r=[`Pon`,`Tor`,`Sre`,`Čet`,`Pet`,`Sob`,`Ned`];function i(e){return e.toLocaleTimeString(`sl-SI`,{hour:`2-digit`,minute:`2-digit`})}return(o,s)=>(T(),x(`div`,_t,[g(`div`,vt,[(T(),x(a,null,h(r,e=>g(`div`,{key:e,class:`text-center text-[11px] font-semibold uppercase text-gray-400 py-1`},R(e),1)),64))]),g(`div`,yt,[(T(!0),x(a,null,h(e.monthDays,r=>(T(),x(`div`,{key:r.toISOString(),class:H([`border border-gray-100 rounded-lg p-1 min-h-[80px] cursor-pointer hover:bg-pink-50 transition-colors flex flex-col`,{"opacity-40":!e.isCurrentMonth(r),"ring-2 ring-pink-400":e.isSameDay(r,N(t))}]),onClick:e=>o.$emit(`add-appointment`,r)},[g(`div`,xt,[g(`span`,{class:H([`text-xs font-semibold w-6 h-6 flex items-center justify-center rounded-full`,e.isSameDay(r,N(t))?`bg-pink-500 text-white`:`text-gray-600`])},R(r.getDate()),3)]),g(`div`,St,[(T(!0),x(a,null,h(e.appointmentsForDay(e.appointments,r).slice(0,3),e=>(T(),x(`div`,{key:e.id,class:`text-[10px] font-medium text-white rounded px-1 truncate cursor-pointer`,style:j({backgroundColor:e.color}),onClick:m(t=>o.$emit(`edit-appointment`,e),[`stop`])},R(i(e.startTime))+` `+R(e.clientName),13,Ct))),128)),e.appointmentsForDay(e.appointments,r).length>3?(T(),x(`div`,wt,` +`+R(e.appointmentsForDay(e.appointments,r).length-3)+` več `,1)):n(``,!0)])],10,bt))),128))])]))}}),Et=f.extend({name:`chip`,style:`
    .p-chip {
        display: inline-flex;
        align-items: center;
...
`,classes:{root:`p-chip p-component`,image:`p-chip-image`,icon:`p-chip-icon`,label:`p-chip-label`,removeIcon:`p-chip-remove-icon`}}),Dt={name:`Chip`,extends:{name:`BaseChip`,extends:y,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:Et,provide:function(){return{$pcChip:this,$parentInstance:this}}},inheritAttrs:!1,emits:[`remove`],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key===`Enter`||e.key===`Backspace`)&&this.close(e)},close:function(e){this.visible=!1,this.$emit(`remove`,e)}},computed:{dataP:function(){return P({removable:this.removable})}},components:{TimesCircleIcon:ae}},Ot=[`aria-label`,`data-p`],kt=[`src`];function At(e,r,i,a,o,s){return o.visible?(T(),x(`div`,c({key:0,class:e.cx(`root`),"aria-label":e.label},e.ptmi(`root`),{"data-p":s.dataP}),[t(e.$slots,`default`,{},function(){return[e.image?(T(),x(`img`,c({key:0,src:e.image},e.ptm(`image`),{class:e.cx(`image`)}),null,16,kt)):e.$slots.icon?(T(),K(F(e.$slots.icon),c({key:1,class:e.cx(`icon`)},e.ptm(`icon`)),null,16,[`class`])):e.icon?(T(),x(`span`,c({key:2,class:[e.cx(`icon`),e.icon]},e.ptm(`icon`)),null,16)):n(``,!0),e.label===null?n(``,!0):(T(),x(`div`,c({key:3,class:e.cx(`label`)},e.ptm(`label`)),R(e.label),17))]}),e.removable?t(e.$slots,`removeicon`,{key:0,removeCallback:s.close,keydownCallback:s.onKeydown},function(){return[(T(),K(F(e.removeIcon?`span`:`TimesCircleIcon`),c({class:[e.cx(`removeIcon`),e.removeIcon],onClick:s.close,onKeydown:s.onKeydown},e.ptm(`removeIcon`)),null,16,[`class`,`onClick`,`onKeydown`]))]}):n(``,!0)],16,Ot)):n(``,!0)}Dt.render=At;var jt=f.extend({name:`autocomplete`,style:`
    .p-autocomplete {
        display: inline-flex;
    }
