import{$t as e,Bt as t,Ct as n,D as r,Dt as i,Gt as a,I as o,It as s,Jt as c,K as l,Lt as u,Nt as d,Pt as f,Q as p,Qt as m,R as h,Rt as g,S as _,St as v,Ut as y,Vt as b,Wt as x,Xt as S,Yt as C,Zt as w,_t as T,an as E,b as D,cn as O,dn as k,en as A,fn as j,ft as M,in as N,ln as P,on as F,pt as I,qt as L,rn as ee,sn as R,tn as z,tt as B,ut as V,v as H,w as U,wt as W,x as G,xt as K,y as te,zt as q}from"./config-B45yrKs1.js";import{n as J,t as ne}from"./portal-D55jaNrn.js";import{a as re,n as ie,o as ae,s as oe,t as se}from"./index-lngRsMFK.js";import{t as Y}from"./appointments-MOXe-3w4.js";import{n as ce,t as le}from"./inputnumber-jemLWR0e.js";import{t as ue}from"./clients-CpWgzjRL.js";import{n as de,r as fe,t as X}from"./inputtext-CVTBCKIw.js";import{i as pe,n as me,r as he,t as ge}from"./select-_1wMbDSA.js";import{t as _e}from"./datepicker-CekwHCRp.js";import{t as ve}from"./textarea-DPiy0R7S.js";function ye(){let e=R(new Date),t=R(`week`);function n(){e.value=new Date}function r(n){let r=new Date(e.value);t.value===`day`?r.setDate(r.getDate()+n):t.value===`week`?r.setDate(r.getDate()+n*7):r.setMonth(r.getMonth()+n),e.value=r}let i=s(()=>{let t=new Date(e.value),n=t.getDay(),r=t.getDate()-n+(n===0?-6:1);return t.setDate(r),t.setHours(0,0,0,0),t}),a=s(()=>Array.from({length:7},(e,t)=>{let n=new Date(i.value);return n.setDate(n.getDate()+t),n})),o=s(()=>{let t=e.value.getFullYear(),n=e.value.getMonth(),r=new Date(t,n,1),i=new Date(t,n+1,0),a=new Date(r),o=a.getDay();a.setDate(a.getDate()-(o===0?6:o-1));let s=new Date(i),c=s.getDay();c!==0&&s.setDate(s.getDate()+(7-c));let l=[],u=new Date(a);for(;u<=s;)l.push(new Date(u)),u.setDate(u.getDate()+1);return l}),c=s(()=>{let e=[];for(let t=0;t<24;t++)for(let n=0;n<60;n+=5)e.push(`${String(t).padStart(2,`0`)}:${String(n).padStart(2,`0`)}`);return e}),l=s(()=>{let n=`sl-SI`;if(t.value===`day`)return e.value.toLocaleDateString(n,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`});if(t.value===`week`){let e=a.value[0],t=a.value[6];return`${e.toLocaleDateString(n,{day:`numeric`,month:`short`})} – ${t.toLocaleDateString(n,{day:`numeric`,month:`short`,year:`numeric`})}`}return e.value.toLocaleDateString(n,{month:`long`,year:`numeric`})});function u(e){return e.getHours()*60+e.getMinutes()}function d(e){return u(e)/5*12}function f(e,t){return(t.getTime()-e.getTime())/6e4/5*12}function p(e){let t=new Date(e),n=t.getMinutes();return t.setMinutes(Math.floor(n/5)*5,0,0),t}function m(e,t){return e.filter(e=>{let n=e.startTime;return n.getFullYear()===t.getFullYear()&&n.getMonth()===t.getMonth()&&n.getDate()===t.getDate()})}function h(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function g(t){return t.getMonth()===e.value.getMonth()}return{currentDate:e,view:t,goToToday:n,navigate:r,startOfWeek:i,weekDays:a,monthDays:o,timeSlots:c,headerLabel:l,SLOT_HEIGHT_PX:12,topForTime:d,heightForDuration:f,snapToFiveMinutes:p,appointmentsForDay:m,isSameDay:h,isCurrentMonth:g,minutesFromMidnight:u}}var be=r.extend({name:`togglebutton`,style:`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,classes:{root:`p-chip p-component`,image:`p-chip-image`,icon:`p-chip-icon`,label:`p-chip-label`,removeIcon:`p-chip-remove-icon`}}),Mt={name:`Chip`,extends:{name:`BaseChip`,extends:U,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:jt,provide:function(){return{$pcChip:this,$parentInstance:this}}},inheritAttrs:!1,emits:[`remove`],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key===`Enter`||e.key===`Backspace`)&&this.close(e)},close:function(e){this.visible=!1,this.$emit(`remove`,e)}},computed:{dataP:function(){return I({removable:this.removable})}},components:{TimesCircleIcon:ie}},Nt=[`aria-label`,`data-p`],Pt=[`src`];function Ft(e,n,r,i,a,o){return a.visible?(S(),t(`div`,L({key:0,class:e.cx(`root`),"aria-label":e.label},e.ptmi(`root`),{"data-p":o.dataP}),[m(e.$slots,`default`,{},function(){return[e.image?(S(),t(`img`,L({key:0,src:e.image},e.ptm(`image`),{class:e.cx(`image`)}),null,16,Pt)):e.$slots.icon?(S(),g(z(e.$slots.icon),L({key:1,class:e.cx(`icon`)},e.ptm(`icon`)),null,16,[`class`])):e.icon?(S(),t(`span`,L({key:2,class:[e.cx(`icon`),e.icon]},e.ptm(`icon`)),null,16)):q(``,!0),e.label===null?q(``,!0):(S(),t(`div`,L({key:3,class:e.cx(`label`)},e.ptm(`label`)),j(e.label),17))]}),e.removable?m(e.$slots,`removeicon`,{key:0,removeCallback:o.close,keydownCallback:o.onKeydown},function(){return[(S(),g(z(e.removeIcon?`span`:`TimesCircleIcon`),L({class:[e.cx(`removeIcon`),e.removeIcon],onClick:o.close,onKeydown:o.onKeydown},e.ptm(`removeIcon`)),null,16,[`class`,`onClick`,`onKeydown`]))]}):q(``,!0)],16,Nt)):q(``,!0)}Mt.render=Ft;var It=r.extend({name:`autocomplete`,style:`
    .p-autocomplete {
        display: inline-flex;
    }
